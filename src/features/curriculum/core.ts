...
export const coreContent: Record<string, TopicContent> = {
  "JS Tutorial": core(
    ...
    {
      prompt: "Where does client-side JS run?",
      options: ["Only databases", "Browsers and Node", "Only CSS", "Only Git"],
      answerIndex: 1,
    },
  ),
  "TS Introduction": core(
    ...
    `export function solve(s: string): string { return ""; }\n`,
    {
      ...
      options: ["Binary", "JavaScript", "CSS", "SQL"],
      answerIndex: 1,
    },
  ),
  "JS Syntax": core(
    ...
    {
      prompt: "Which keyword prevents reassignment?",
  ...
  "TS Explicit & Inference": core(
    ...
    {
      prompt: "When is explicit annotation most useful?",
      options: ["Never", "Public function signatures", "Comments only", "CSS"],
      answerIndex: 1,
    },
  ),
  ...
  "TS Special Types": core(
    ...
    {
      prompt: "Which type is safest for unknown input?",
  ...
  "JS Loops": core(
    ...
    {
      prompt: "Which loop iterates array values?",
      options: ["for...in", "for...of", "while false", "do CSS"],
      answerIndex: 1,
    },
  ),
  "TS Arrays": core(
    ...
    {
      prompt: "How do you type an array of strings?",
      options: ["string", "Array<string>", "Both B and string[]", "map"],
      answerIndex: 2,
    },
  ),
  "JS Strings": core(
    ...
    `export function solve(s: string): string { return ""; }\n`,
    {
      prompt: "Are strings mutable in JS?",
      options: ["Yes", "No", "Only in TS", "Only arrays"],
      answerIndex: 1,
    },
  ),
  "TS Tuples": core(
    ...
    {
      prompt: "Tuples are best for?",
      options: ["Any length list", "Fixed positions with types", "CSS", "DOM"],
      answerIndex: 1,
    },
  ),
  "JS Numbers": core(
  ...
  "TS Object Types": core(
    ...
    {
      prompt: "Optional props use which syntax?",
      options: ["name?", "optional name", "?name", "name!"],
      answerIndex: 0,
    },
  ),
  "TS Classes": core(
    ...
    `export function solve(n: number): number { return 0; }\n`,
    {
      prompt: "public in constructor params does what?",
      options: ["Nothing", "Creates a property", "Deletes field", "CSS"],
      answerIndex: 1,
    },
  ),
  "JS Scope": core(
    ...
    {
      prompt: "let and const are scoped to?",
      options: ["Function only", "Nearest block", "Global always", "Module CSS"],
      answerIndex: 1,
    },
  ),
  "TS Enums": core(
    ...
    {
      prompt: "String enums help with?",
      options: ["Runtime CSS", "Readable named constants", "Deleting types", "Loops"],
      answerIndex: 1,
    },
  ),
  "TS Aliases & Interfaces": core(
    ...
    {
      prompt: "interface is best for?",
      options: ["Primitives only", "Object contracts you extend", "CSS", "Loops"],
      answerIndex: 1,
    },
  ),
  "JS Sets": core(
    ...
    `export function solve(arr: number[]): number { return 0; }\n`,
    {
      prompt: "Set automatically does what?",
      options: ["Sorts", "Deduplicates", "Parses JSON", "Renders DOM"],
      answerIndex: 1,
    },
  ),
  "TS Casting": core(
    ...
    `export function solve(s: string): number { return 0; }\n`,
    {
      prompt: "Casting should be used when?",
      options: ["Always", "You verified the shape", "Never type", "For CSS"],
      answerIndex: 1,
    },
  ),
  "JS Maps": core(
    ...
    `export function solve({ entries, key }: { entries: [string, number][]; key: string }): number | undefined {\n  const m = new Map(entries);\n  return m.get(key);\n}\n`,
    {
      ...
      options: ["Only strings", "Any type", "Only numbers", "Only symbols"],
      answerIndex: 1,
    },
  ),
  "JS Iterations": core(
    ...
    {
      prompt: "for...of works on?",
      options: ["Plain objects by default", "Iterables like arrays", "CSS files", "SQL only"],
      answerIndex: 1,
    },
  ),
  "TS Utility Types": core(
    ...
    {
      prompt: "Partial<T> makes properties?",
      options: ["Required", "Optional", "Readonly", "Deleted"],
      answerIndex: 1,
    },
  ),
  "JS Math": core(
    ...
    `export function solve(pair: [number, number]): number { return 0; }\n`,
    {
      prompt: "Math.random returns?",
      options: ["Integer 1-10", "0 <= n < 1", "Always 0.5", "A Promise"],
      answerIndex: 1,
    },
  ),
  "TS Keyof": core(
    ...
    {
      prompt: "keyof helps prevent?",
      options: ["Typos in property names", "Network errors", "CSS bugs", "Git conflicts"],
      answerIndex: 0,
    },
  ),
  "JS RegExp": core(
    ...
    {
      prompt: "RegExp.test returns?",
      options: ["string", "boolean", "array", "Promise"],
      answerIndex: 1,
    },
  ),
};
