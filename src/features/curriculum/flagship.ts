...
export const flagshipContent: Record<string, TopicContent> = {
  "JS Arrays": {
    summary: "Arrays store ordered values. Use map/filter/reduce for transformations without mutating originals when possible.",
    objectives: ["Create and index arrays", "Use map and reduce safely", "Choose array vs object storage"],
    ...
    quizQ3: {
      ...
      options: ["It is always faster", "It expresses aggregation clearly", "It removes types", "It avoids memory"],
      answerIndex: 1,
    },
  },
  "JS Functions": {
    summary: "Functions package reusable logic. Arrow functions inherit lexical `this`; declarations are hoisted.",
    objectives: ["Declare functions", "Pass arguments and return values", "Pick arrow vs function syntax"],
  ...
  "JS Objects": {
    summary: "Objects group related keys and values. Use shorthand properties and optional chaining for safe access.",
    objectives: ["Create object literals", "Read and update properties", "Avoid accidental mutation"],
    ...
    tests: [
      { label: "name", input: { first: "Ada", last: "Lovelace" }, expected: "Ada Lovelace" },
    ],
    quizExtra: {
  ...
  "JS Asynchronous": {
    ...
    tests: [
      { label: "resolved", input: 42, expected: 42 },
    ],
    quizExtra: {
      prompt: "What does await do inside an async function?",
      options: ["Blocks the CPU forever", "Pauses the function until a promise settles", "Deletes the promise", "Runs sync code later"],
      answerIndex: 1,
    },
  },
  "JS Errors": {
    summary: "Throw and catch errors to handle failure paths explicitly instead of silent bugs.",
    objectives: ["Use try/catch/finally", "Throw meaningful errors", "Distinguish expected vs programmer errors"],
    ...
    tests: [
      { label: "ok", input: 2, expected: 2 },
    ],
    hint: "Use if (n < 0) throw new Error('negative')",
    quizExtra: {
      prompt: "When should you throw an error?",
      options: ["For normal control flow", "When continuing is impossible", "Every function", "Never"],
      answerIndex: 1,
    },
  },
  "TS Simple Types": {
    ...
    quizExtra: {
      ...
      options: ["Runtime cast", "Compile-time type annotation", "HTML attribute", "Database column"],
      answerIndex: 1,
    },
  },
  "TS Functions": {
    summary: "Function types describe parameters and return values for safer APIs.",
    objectives: ["Type parameters and returns", "Use optional parameters", "Prefer explicit return types on public APIs"],
  ...
  "TS Union Types": {
    ...
    challengePrompt: "Given string | number, return its length (string length or number digit count as string).",
    ...
    quizExtra: {
      ...
      options: ["For speed only", "So TypeScript knows the exact shape", "To remove JS", "For styling"],
      answerIndex: 1,
    },
  },
  "TS Basic Generics": {
    summary: "Generics write reusable functions and types while preserving input/output relationships.",
  ...
  "TS Type Guards": {
    ...
    objectives: ["Use typeof and custom guards", "Model discriminated unions", "Return early on invalid shapes"],
