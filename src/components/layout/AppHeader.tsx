  ...
  return (
    <header className="glass sticky top-0 z-40 mb-6 flex items-center justify-between px-4 py-3">
      <div className="flex items-center gap-6">
        <Link to="/" className="text-lg font-bold tracking-tight">NerdStack Academy</Link>
      ...
      <div className="flex items-center gap-3">
        {user ? (
          <>
            ...
            <button className="btn btn-ghost" onClick={() => void signOut().then(() => window.location.assign("/signin"))}>
              Logout
            </button>
          </>
        ) : (
